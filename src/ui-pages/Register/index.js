        ...
        <div>
          ...
          <div>
            <TextFieldComponent
              ...
              handleChange={(e) => {
                setAppData("signup.userName", e.target.value);
              }}
              fullwidth={"true"}
            />
            ...
            <TextFieldComponent
              ...
              handleChange={(e) => {
                setAppData("signup.emailId", e.target.value);
              }}
              fullwidth={"true"}
              type={"text"}
            />
            ...
            <TextFieldComponent
              ...
              value={phoneNumber}
              hasError={
                !phoneNumber || !this.state.errors.phoneNumber ? true : false
              }
              errorMessage={this.state.errors.phoneNumber}
              placeholder={"phone Number"}
              handleChange={(e) => {
                setAppData("signup.phoneNumber", e.target.value);
              }}
              fullwidth={"true"}
              maxLength={10}
              minlength={10}
            ...
            <TextFieldComponent
              ...
              handleChange={(e) => {
                setAppData("signup.password", e.target.value);
              }}
              fullwidth={"true"}
              type={"password"}
            />
            ...
            <TextFieldComponent
              ...
              handleChange={(e) => {
                setAppData("signup.confirmPassword", e.target.value);
              }}
              fullwidth={"true"}
            />
          </div>
